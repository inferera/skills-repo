    ...
    <div className="space-y-12">
      ...
      <section className="text-center py-12 sm:py-16">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-muted text-accent text-sm font-medium mb-6">
          ...
          <span>{index.skills.length} Skills Available</span>
        </div>
        ...
        <p className="text-lg sm:text-xl text-secondary max-w-2xl mx-auto mb-8">
          A community-maintained registry of skills for AI agents. Import from GitHub, keep everything reviewable via PRs.
        </p>
          ...
          {categories.categories.map((c) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs text-muted mt-1">{skillCount} skills</span>
              </Link>
            );
          })}
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-heading text-xl font-semibold text-foreground">All Skills</h2>
        </div>
